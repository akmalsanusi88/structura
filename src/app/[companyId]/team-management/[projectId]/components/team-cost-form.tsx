...
export default function TeamCostForm({ project, cost, onSave, onCancel, inHouseTeams }: TeamCostFormProps) {
                   ...
                   <Select onValueChange={field.onChange} defaultValue={field.value} disabled={!!cost}>
                    ...
                    <SelectContent>
                        {inHouseTeams.length > 0 ? (
                            ...
                            <SelectItem value="disabled" disabled>No in-house teams found</SelectItem>
                        )}
                    </SelectContent>
                  </Select>
                  <FormMessage />
